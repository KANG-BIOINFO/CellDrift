...
# logging.basicConfig(level = logging.INFO, filename = 'celldrift.log', filemode = 'w', 
...
def setup_celldrift(adata, cell_type_key, perturb_key, size_factor_key, control_name, batch_key, perturb_name = None, min_cells_perGene = None):
    """
    ...
    min
    """
    logger.info("start to set up the celldrift object.")
    ...
    adata.uns["celldrift"]["figure_dir"] = "figures_celldrift/"

    # set up the output directory
    if not os.path.isdir("output_celldrift"):
        os.mkdir("output_celldrift")
    adata.uns["celldrift"]["output_dir"] = "output_celldrift/"
